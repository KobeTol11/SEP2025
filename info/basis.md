...
Voor onze groep is dit dus: `g07-syndus.internal`.
...
- Gebruik `g07-syndus.internal` als root domain voor Active Directory. Zo vermijd je conflicten met de webserver (zie verder).
