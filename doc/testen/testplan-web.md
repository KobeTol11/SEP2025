...
- Je kunt de website bezoeken op `http://192.168.207.60/`.
...
1. Surf naar `http://192.168.207.60/`.
...
- Je kunt de website bezoeken op `http://192.168.207.50/`.
...
1. Log in op het WordPress-dashboard via `http://192.168.207.50/wp-admin/`.
