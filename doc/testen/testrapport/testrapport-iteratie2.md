...
2. Stel deze interface in als **DHCP-client** of gebruik een **statisch IP** (`172.22.200.X`).
3. Configureer NAT:
   ...
   - Stel een access-list op die interne IP-ranges toelaat (vb. `access-list 1 permit 192.168.20X.0 0.0.0.255`)
4. Test NAT:
