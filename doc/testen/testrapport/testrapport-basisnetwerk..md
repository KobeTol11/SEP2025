...
- [x] Elke pc krijgt correct IP-adres toegewezen.
- [x] `ping` naar eigen gateway slaagt.
- [x] `ping` tussen VLANs slaagt: toont werkende **router-on-a-stick**.

Opmerkingen:

- router on a stick heeft een apart test rapport
...
- [x] Het apparaat krijgt een IP-adres binnen bereik (bijv. `192.168.207.130`).
- [x] `ping`-testen zijn succesvol.
...
- [x] `ping` naar de ISP-router werkt.
- [x] Verkeer uit je netwerk kan de default gateway gebruiken.
