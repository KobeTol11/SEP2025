...
[vagrant@reverseproxy ~]$ curl -I -H https://nextcloud.g07-syndus.internal
[vagrant@reverseproxy ~]$ curl -I -H https://jellyfin.g07-syndus.internal
```
``
...
[vagrant@reverseproxy ~]$ nslookup jellyfin.g07-syndus.internal
[vagrant@reverseproxy ~]$ nslookup nextcloud.g07-syndus.internal
```
...
- [x]  DNS-resolutie via nslookup juist functioneert.
 - Toont niet de correcte webpagina
